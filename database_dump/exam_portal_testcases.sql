...
CREATE TABLE `testcases` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKtkgjrtlc8jwm78kxfe6qc5t3a` (`coding_question_id`),
  CONSTRAINT `FKtkgjrtlc8jwm78kxfe6qc5t3a` FOREIGN KEY (`coding_question_id`) REFERENCES `coding_questions` (`id`)
